...
A[o['O_CL'], s['O_RL']] = 0.5
A[o['O_CL'], s['O_RR']] = 0.5
A[o['L_RW'], s['L_RL']] = alpha_A
A[o['L_RW'], s['L_RR']] = 1 - alpha_A
A[o['R_RW'], s['R_RL']] = 1 - alpha_A
A[o['R_RW'], s['R_RR']] = alpha_A
A[o['C_CL'], s['C_RL']] = 1
A[o['C_CR'], s['C_RR']] = 1
A[o['O_CR'], s['O_RL']] = 0.5
A[o['O_CR'], s['O_RR']] = 0.5
A[o['L_NR'], s['L_RL']] = 1 - alpha_A
A[o['L_NR'], s['L_RR']] = alpha_A
A[o['R_NR'], s['R_RL']] = alpha_A
A[o['R_NR'], s['R_RR']] = 1 - alpha_A

# alpha-Matrix parameters of Dirichlet distribution p(A)
epsilon = 0.1
alpha = np.ones((16, 8)) * epsilon
#alpha = np.zeros((16, 8))
alpha[o['O_CL'], s['O_RL']] = 10
alpha[o['O_CL'], s['O_RR']] = 10
alpha[o['O_CR'], s['O_RL']] = 10
alpha[o['O_CR'], s['O_RR']] = 10
alpha[o['L_RW'], s['L_RL']] = 1
alpha[o['L_NR'], s['L_RR']] = 1
alpha[o['R_NR'], s['R_RL']] = 1
alpha[o['R_RW'], s['R_RR']] = 1
alpha[o['C_CL'], s['C_RL']] = 1
alpha[o['C_CR'], s['C_RR']] = 1
